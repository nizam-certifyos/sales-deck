          ...
          <div className="demo-export-section">
            <div className="demo-export-left">
              <div className="demo-export-title">
                {downloadState === "ready" ? "Your processed file is ready." : "Building your processed file..."}
              </div>
